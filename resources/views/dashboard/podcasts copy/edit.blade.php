            ...
            <main class="col-12 col-md-12">
                ...
                <section id="mainForm">
                    ...
                    <section class="my-4">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{route('podcasts.update',$thispage->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method("PUT")
                                    <div class="md-form form-outline form-gold my-5">
                                        <input type="text" id="uri" name="uri" class="form-control" value="{{$thispage->uri}}" />
                                        <label class="form-label" for="uri">uri</label>
                                    </div>
                                    <div class="md-form form-outline form-gold my-5">
                                        <input type="text" id="title" name="title" class="form-control" value="{{$thispage->title}}" />
                                        <label class="form-label" for="title">title</label>
                                    </div>
                                    <div class="md-form form-outline form-gold my-5">
                                        <input type="text" id="post_desc" name="post_desc" class="form-control" value="{{$thispage->post_desc}}" />
                                    ...
                                    <div class="md-form form-outline form-gold my-5">
                                        ...
                                        <textarea name="content" id="content" cols="30" rows="10" class="summernote summernote-elemant">{!! $thispage->content !!}</textarea>
